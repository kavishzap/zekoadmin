...
const Types = lazy(() => import('../pages/Apps/types'));
const Concerts = lazy(() => import('../pages/Apps/concerts'));
const Tickets = lazy(() => import('../pages/Apps/tickets'));
const UsersLists = lazy(() => import('../pages/Apps/UsersList'));
const Bookings = lazy(() => import('../pages/Apps/bookings'));
const Zeko_Dashboard = lazy(() => import('../pages/Apps/zeko_dashboard'));
